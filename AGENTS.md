...
复杂多步任务（预计 5 次以上工具调用、跨阶段开发、研究排查类工作）须使用 **planning-with-files** Skill（已全局安装于 `~/.Codex/skills/planning-with-files/`）进行文件化规划：
...
2. **同步更新**：如有架构变更、新增模块、或者新的验证流程，需同步更新本文档 (`AGENTS.md`)、`README.md`、`doc/下一步计划.md` 等对应文档
3. 记录内容至少包含：日期、触发背景、操作摘要表、验证结果、最终提交 hash
4. 本文档 (`AGENTS.md`) 和 `memory/ai_step.md` 作为长期维护文档，不得删除或重置
